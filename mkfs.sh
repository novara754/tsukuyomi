...
dd if=/dev/zero of=hdd.img bs=512 count=$((128 * 1024 * 1024 / 512))
...
sudo mkfs.fat -v -F 12 /dev/loop0
mkdir -p hdd_esp
...
# sudo losetup /dev/loop1 hdd.img --offset $((17 * 1024 * 1024))
